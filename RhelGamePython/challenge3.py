...
def challenge_3():
    ...
    """
    try:
        slow_validInput.print_slow("Challenge 3: Conquer Volume Groups")
        ...
        while True:
            ...
            if choice == '1':
                ...
                volume_groups.check_create_volume_group_command()
                ...
                volume_groups.check_extend_volume_group_command()
                ...
                volume_groups.check_remove_volume_group_command()
                ...
                volume_groups.check_view_volume_groups_command()
                ...
                volume_groups.check_remove_physical_volume_command()

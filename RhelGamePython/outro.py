...
def conclusion():
    ...
    try:
        ...
        slow_validInput.print_slow("Now, as you stand at the threshold of victory, you realize that your journey was about more than just mastering the intricacies of Linux systems.")
        slow_validInput.print_slow("It was about growth, discovery, and the relentless pursuit of knowledge.")
        slow_validInput.print_slow("You leave the digital realm not only as a master of Red Hat administration, but as a wiser, more capable individual, ready to face whatever challenges the future may hold.")
        slow_validInput.print_slow("Congratulations, adventurer. You have completed the Red Hat Odyssey, and your legend will be remembered for generations to come.")

...
def challenge_6():
    ...
    """
    try:
        slow_validInput.print_slow("Challenge 6: Configure File System Mounting with UUID or Label")
        ...
        while True:
            ...
            if choice == '1':
                ...
                partitions_filesystem.create_ext4_on_lvm()
                partitions_filesystem.check_uuid_command()
                uuid_mount.edit_fstab()
                uuid_mount.mount_partition()
                ...
                label_mount.check_e2label_tune2fs_command()

...
def challenge_4():
    ...
    """
    try:
        slow_validInput.print_slow("Challenge 4: Uncover Disk Secrets")
        ...
        while True:
            ...
            if choice == '1':
                ...
                physical_volumes.view_physical_volumes()
                ...
                physical_volumes.create_physical_volume()
                ...
                physical_volumes.remove_physical_volume()

...
command_options = ["The systemctl get-default command doesn't have any specific options. It's a simple command used to retrieve the default target (runlevel) of the system. Therefore, you just use it as is without any additional flags or options.",],
intro_text = [''],
outro_text = [''],
)
